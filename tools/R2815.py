...
def main():
    ...
    notes = []
    notes.append(f"# {RID} – HOTFIX purge call signature\n\n")
...
def action_tools_purge_scan(app):
    ...
    return logic_actions._r1851_run_tools_runner(app, "R2218")
""".strip("\n")
...
def action_tools_purge_apply(app):
    ...
    from modules import logic_actions
    return logic_actions._r1851_run_tools_runner(app, "R2224")
""".strip("\n")
